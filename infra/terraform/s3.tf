resource "aws_s3_bucket" "s3" {
  bucket        = "gaiauniquebucketfromeriktortajadarodriguez"
    ...
    Statement = [
      {
        ...
        Action    = "s3:GetObject"
        Principal = "*"
        Resource  = "arn:aws:s3:::gaiauniquebucketfromeriktortajadarodriguez/*" # Aplica a los objetos dentro del bucket
      }
    ]
  })
}
